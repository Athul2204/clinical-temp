...
class MedicineViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        serializer.save()
        return Response({"message": "Medicine added successfully", "data": serializer.data}, status=status.HTTP_201_CREATED)
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        serializer.save()
        return Response({"message": "Medicine updated successfully", "data": serializer.data})
...
class MedicineBatchViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        serializer.save()
        return Response({"message": "Medicine batch added successfully", "data": serializer.data}, status=status.HTTP_201_CREATED)
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        serializer.save()
        return Response({"message": "Medicine batch updated successfully", "data": serializer.data})

    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        instance.delete()
        return Response({"message": "Medicine batch deleted successfully"}, status=status.HTTP_204_NO_CONTENT)
...
class DispenseViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        dispense = serializer.save()
        return Response({"message": "Medicine dispensed successfully", "data": DispenseSerializer(dispense).data}, status=status.HTTP_201_CREATED)
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        serializer.save()
        return Response({"message": "Dispense updated successfully", "data": serializer.data})

    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        instance.delete()
        return Response({"message": "Dispense deleted successfully"}, status=status.HTTP_204_NO_CONTENT)


# ==============================
# DISPENSE ITEM (READ-ONLY)
# ==============================
class DispenseItemViewSet(ReadOnlyModelViewSet):
    queryset = DispenseItem.objects.all()
    serializer_class = DispenseItemSerializer
...
class MedicineBillViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response({"message": "Medicine bill created successfully", "data": serializer.data}, status=status.HTTP_201_CREATED)
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        serializer.save()
        return Response({"message": "Medicine bill updated successfully", "data": serializer.data})
...
# ==============================
# SENT PRESCRIPTIONS (PHARMACIST)
# ==============================
class SentPrescriptionListView(APIView):
    permission_classes = [IsAuthenticated, IsPharmacist]

    def get(self, request):
        prescriptions = Prescription.objects.filter(status="Sent").select_related(
            'consultation__appointment__patient', 'doctor'
        ).prefetch_related('items__medicine_name')
        serializer = IncomingPrescriptionSerializer(prescriptions, many=True)
        return Response({"message": "Sent prescriptions fetched successfully", "count": prescriptions.count(), "data": serializer.data}, status=status.HTTP_200_OK)
...
class SentPrescriptionDetailView(APIView):
    ...
    def get(self, request, prescription_code):
        try:
            prescription = Prescription.objects.select_related(
                'consultation__appointment__patient', 'doctor'
            ).prefetch_related('items__medicine_name').get(prescription_code=prescription_code, status="Sent")
        except Prescription.DoesNotExist:
            return Response({"message": "Prescription not found or not yet sent"}, status=status.HTTP_404_NOT_FOUND)

        serializer = IncomingPrescriptionSerializer(prescription)
        return Response({"message": "Prescription details fetched successfully", "data": serializer.data}, status=status.HTTP_200_OK)